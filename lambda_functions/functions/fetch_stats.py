...
def lambda_handler(event, context):
    ...
    upload_to_s3('./fangraphs_fb_data.json', BUCKET_NAME, 'fangraphs_fb_data.json')
    upload_to_s3('./fangraphs_barrel_hh_data.json', BUCKET_NAME, 'fangraphs_barrel_hh_data.json')
